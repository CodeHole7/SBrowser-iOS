...
@implementation Ipv6HelperSBrowser
...
+ (NSInteger) ipv6_status {
    ...
    if (reach.currentReachabilityStatus != NotReachable) {
        ...
        NSDictionary *ipv4addrs = [Ipv6HelperSBrowser addressesForProtocol:4];
        ...
        NSDictionary *ipv6addrs = [Ipv6HelperSBrowser addressesForProtocol:6];
