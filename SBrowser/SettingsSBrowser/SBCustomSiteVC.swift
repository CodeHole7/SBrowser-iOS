...
class SBCustomSiteVC: SBSearchTableVC {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        hosts = HostSettingsSBrowser.hosts

        for host in hosts {
            levels[host] = SecurityPreset(HostSettingsSBrowser.for(host))
        }
    ...
    override func tableView(_ tableView: UITableView, commit
        ...
        if editingStyle == .delete {
            ...
            HostSettingsSBrowser.remove(host).store()
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.section == 0 {
            ...
            navigationController?.pushViewController(AddSiteSBrowserVC(), animated: true)
        }
