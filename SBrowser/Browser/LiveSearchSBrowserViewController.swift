...
class LiveSearchSBrowserViewController: UITableViewController {
   ...
   var searchOngoing = false
        ...
        private weak var tab: TabSBrowser?
        ...
        func update(_ query: String?, tab: TabSBrowser?) {
            ...
            guard let request = LiveSearchSBrowserViewController.constructRequest(query, autocomplete: true) else {
                return
            }
        ...
        */
        class func constructRequest(_ query: String?, autocomplete: Bool = false) -> URLRequest? {
            guard let se = SettingsSBrowser.searchEngine,
